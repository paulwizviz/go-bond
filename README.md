# `go-bond`: An Experimental Go-base AI Agent SDK
...
`go-bond` is provided as-is, without any guarantees or support. While every effort has been made to ensure the library is reliable and functional, users shall assume all risks associated with its use.
...
Copyright 2024 The Contributors to `go-bond`
